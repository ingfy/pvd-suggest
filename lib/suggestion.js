...
Strategy.prototype.suggest = function (period, result, maxNum) {
    var strat = result.parseResult.complete ? this.complete : this.incomplete;

    return strat(period, result.parseResult, maxNum);
};
